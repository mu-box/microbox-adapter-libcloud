...
class Model(object):
    ...
    def to_microbox(self) -> dict:
        """Returns the data in a representation which can be converted to JSON and is expected by the Microbox client."""
...
class AdapterMeta(Model):
    ...
    def to_microbox(self) -> typing.Dict[str, typing.Any]:
        return {
            'id': self.id,
            'name': self.name,
...
class ServerPlan(Model):
    ...
    def to_microbox(self) -> typing.Dict[str, typing.Any]:
        return {
            'id': self.id,
            'name': self.name,
            'specs': [spec.to_microbox() for spec in self.specs],
        }
...
class ServerRegion(Model):
    ...
    def to_microbox(self) -> typing.Dict[str, typing.Any]:
        return {
            'id': self.id,
            'name': self.name,
            'plans': [plan.to_microbox() for plan in self.plans],
        }
