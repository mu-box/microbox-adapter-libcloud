...
from microbox_libcloud import tasks
from microbox_libcloud.adapters import Adapter
from microbox_libcloud.adapters.base import RebootMixin
...
class AzureARM(RebootMixin, Adapter):
    ...
    auth_instructions = ('Use the instructions at '
        ...
        'a new one and update your Microbox hosting provider account settings. '
        'When assigning your app a role, select <code>Contributor</code> to '
        'grant Microbox permission to create and manage servers and associated '
