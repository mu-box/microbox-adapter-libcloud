...
from microbox_libcloud.utils import models
...
class Adapter(object, metaclass=AdapterBase):
    """
    Base class for Microbox libcloud adapters. Implements basic functionality that should work for most libcloud drivers
    ...
    server_bootstrap_script = 'https://s3.amazonaws.com/tools.microbox.cloud/bootstrap/ubuntu.sh'  # type: str
