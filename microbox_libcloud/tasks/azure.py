from microbox_libcloud import celery
from microbox_libcloud import adapters
...
def azure_create_classic(headers, data):
    ...
    logger.info('Adding Microbox ports...')
    while True:
        try:
            driver.ex_set_instance_endpoints(node, [
                ...
                {"name": 'MicroAgent SSH', "protocol": 'TCP', "port": 1289, "local_port": 1289},
                ...
                {"name": 'MicroAgent API', "protocol": 'TCP', "port": 8570, "local_port": 8570},
            ], 'production')
